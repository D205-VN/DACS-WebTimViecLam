...
async function updateQuestion() {
  try {
    ...
    if (result.rows.length > 0) {
      ...
      await pool.query('UPDATE ai_questions SET video_url = $1 WHERE id = $2', ['https://www.youtube.com/embed/uqlAzC127o8?autoplay=1&mute=1&loop=1&playlist=uqlAzC127o8&controls=0', questionId]);
