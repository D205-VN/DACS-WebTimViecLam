      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-navy-800 via-navy-700 to-navy-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          ...
          <p className="text-lg text-navy-200 leading-relaxed max-w-md">
            Đăng nhập để tiếp tục hành trình tìm kiếm công việc mơ ước và quản lý hồ sơ ứng tuyển của bạn.
          </p>
          ...
          <div className="flex gap-8 mt-12">
            <div>
              ...
              <p className="text-sm text-navy-300 mt-1">Việc làm mới</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-white">8,200+</p>
              <p className="text-sm text-navy-300 mt-1">Nhà tuyển dụng</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">
              Chưa có tài khoản?{' '}
              <Link to="/register" className="text-navy-700 font-semibold hover:text-navy-800 transition-colors">
                Đăng ký ngay
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#" className="text-xs text-navy-600 hover:text-navy-800 font-medium transition-colors">
                  Quên mật khẩu?
                </a>
              </div>
              <div className="relative">
